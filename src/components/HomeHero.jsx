...
const HomeHero = () => {
  return (
    ...
    >
      <Container
        size="4"
        className="flex justify-center items-center mx-auto mt-24"
      >
        <Flex
          gap="4"
        ...
        >
          ...
          <Box className="flex-1 flex flex-col items-end text-background">
            <Flex direction="column" gap="3" className="w-full md:w-auto">
              <Heading size="9" align="right">
                The leading call recorder app for iPhone and Android
              </Heading>
          ...
          <Box className="flex-2">
            <img
              ...
              loading="lazy"
              alt="TapeACall App"
              className="image mx-auto h-auto max-w-7xl sm:mx-2 md:mx-2 w-100"
            />
          </Box>
        </Flex>
      </Container>
